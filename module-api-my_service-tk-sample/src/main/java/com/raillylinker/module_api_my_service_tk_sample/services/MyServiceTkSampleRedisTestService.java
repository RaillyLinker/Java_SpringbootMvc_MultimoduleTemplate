 ...
 */
public interface MyServiceTkSampleRedisTestService {
    // (Redis Key-Value 입력 테스트)
    void insertRedisKeyValueTest(
    ...
    MyServiceTkSampleRedisTestController.SelectRedisValueSampleOutputVo selectRedisValueSample(
            @Valid @NotNull @org.jetbrains.annotations.NotNull
            HttpServletResponse httpServletResponse,
            @Valid @NotNull @org.jetbrains.annotations.NotNull
            String key
    ...
    @Nullable
    @org.jetbrains.annotations.Nullable
    MyServiceTkSampleRedisTestController.SelectAllRedisKeyValueSampleOutputVo selectAllRedisKeyValueSample(
            @Valid @NotNull @org.jetbrains.annotations.NotNull
            HttpServletResponse httpServletResponse
    );
    ...
    @Nullable
    @org.jetbrains.annotations.Nullable
    MyServiceTkSampleRedisTestController.TryRedisLockSampleOutputVo tryRedisLockSample(
            @Valid @NotNull @org.jetbrains.annotations.NotNull
            HttpServletResponse httpServletResponse
    );
