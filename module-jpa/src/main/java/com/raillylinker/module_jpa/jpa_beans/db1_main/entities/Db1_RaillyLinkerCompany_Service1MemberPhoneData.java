...
public class Db1_RaillyLinkerCompany_Service1MemberPhoneData {
    public Db1_RaillyLinkerCompany_Service1MemberPhoneData() {
    }
    ...
    // [@OneToMany 변수들]
    @OneToMany(
            mappedBy = "frontService1MemberPhoneData",
