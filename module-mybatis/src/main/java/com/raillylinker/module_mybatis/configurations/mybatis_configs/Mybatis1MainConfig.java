...
public class Mybatis1MainConfig {
    // !!!application.yml 의 mybatis 안에 작성된 이름 할당하기!!!
    @Valid
    @NotNull
    @org.jetbrains.annotations.NotNull
    public static final String MYBATIS_CONFIG_NAME = "mybatis1-main";

    @Valid
    @NotNull
    @org.jetbrains.annotations.NotNull
    public static final String MYBATIS_MAPPERS_NAME = "mybatis1_main";
