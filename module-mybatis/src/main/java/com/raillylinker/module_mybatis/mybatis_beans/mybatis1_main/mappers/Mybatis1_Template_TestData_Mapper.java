...
public interface Mybatis1_Template_TestData_Mapper {
    @Insert("INSERT INTO template.test_data (uid, row_create_date, row_update_date, row_delete_date_str, content, random_num, test_datetime) VALUES (#{uid}, #{rowCreateDate}, #{rowUpdateDate}, #{rowDeleteDateStr}, #{content}, #{randomNum}, #{testDatetime})")
